  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{route('tramites.update' ,$tramites->id )}}" method="POST">
            @method('put')
            @csrf
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control  " name="{{$campo}}" value="{{ $tramites->$campo}}">
              </div>
            </div>
            ...
            <a href="{{route('tramites.ver',$tramites->id)}}" class="btn btn-danger">Cancelar</a>
